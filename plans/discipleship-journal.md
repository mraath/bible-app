...
A Navigator's plan with 4 readings per day across 4 streams, 25 days per month. Covers the entire Bible in one year with built-in catch-up days.
...
| DAY | LUKE     | COLOSSIANS      | PSALMS  | 1 CHRONICLES |
| --- | -------- | --------------- | ------- | ------------ |
